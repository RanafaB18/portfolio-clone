...
const ContactMe = () => {
  ...
  return (
    <section id="contact" className="relative md:max-w-4xl md:mx-auto">
      <h2 className="text-2xl text-center font-bold mt-24 mb-10 md:text-4xl">
        Send me a message
      </h2>
      <div className="md:grid md:grid-flow-col md:grid-cols-2">
        <div className="p-8 pb-6 bg-[#6e6e6e] bg-opacity-20 text-sm rounded-tl rounded-bl">
          <p className="md:pt-44">
        ...
        <div className="bg-[#6e6e6e] bg-opacity-10 rounded-tr rounded-br">
          <form
            ref={form}
            onSubmit={sendEmail}
            className="flex flex-col gap-3 pt-8 pb-3 px-4 md:p-10"
          >
            <input
